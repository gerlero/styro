...
def get_test_platform_path() -> Path:
...
class MockCLIPackage(Package):
    ...
    _instances: ClassVar[Dict[str, "MockCLIPackage"]] = {}  # Class variable to track instances
    ...
    @classmethod
    def get_instance(cls, name: str) -> "MockCLIPackage":
    ...
    def configure(self, metadata: Optional[Dict[str, Any]] = None, apps: Optional[list] = None, libs: Optional[list] = None) -> None:
    ...
    async def install(self, *, upgrade: bool = False, _force_reinstall: bool = False, _deps: bool = True) -> None:
